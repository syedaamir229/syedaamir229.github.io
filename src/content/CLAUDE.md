...
- Set `date` to a scheduled future Thursday so the post drips on cadence; it stays hidden until that day. See [BLOG.md section 11](../../docs/BLOG.md#11-publishing-cadence-and-distribution).
- Every post still gets a LinkedIn companion, but it is written in the content hub, not here. Landing the post is where this repo's job ends.
