...
6. Write the LinkedIn companion at `social/linkedin/<slug>.md` per [docs/LINKEDIN.md](../docs/LINKEDIN.md). Same slug, embeds the canonical post URL. This is a plain markdown sidecar outside `src/`, so it is never built or schema-validated.
