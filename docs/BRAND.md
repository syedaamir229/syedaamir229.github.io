...
Surface-specific operational specs ([SITE.md](SITE.md), [BLOG.md](BLOG.md), [PROJECTS.md](PROJECTS.md), and the LinkedIn companion spec in the content hub) refer up here for tone and inherit it; they only describe what is unique to that surface. If you find tone rules being duplicated in two files, fix the drift.
...
- **Voice in practice per surface**: [SITE.md](SITE.md) (landing), [BLOG.md](BLOG.md) (blog posts), [PROJECTS.md](PROJECTS.md) (case studies). LinkedIn companions inherit this voice too, from their spec in the content hub.
