...
### Pick the visual first: the post-format decision matrix
...
### When the post carries a visual, the caption complements it and never repeats it
...
### Porting and the clean-card trick (link-only posts)
