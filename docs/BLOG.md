...
Distribution. Every post ships with a LinkedIn companion (see [LINKEDIN.md](LINKEDIN.md)). The blog post is the long-form credibility play; the LinkedIn post is the reach play. Publishing one without the other leaves most of the value on the table. Share the companion on Wednesday, early-to-mid afternoon Gulf time, a window that overlaps a live Gulf afternoon, European midday, and a US-East morning. Put the canonical post URL near the end of the copy, not the first line.
...
- **LinkedIn companion spec**: [LINKEDIN.md](LINKEDIN.md).
