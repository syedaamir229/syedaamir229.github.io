...
| [BLOG.md](BLOG.md) | Per-post writing spec: two post shapes, seven-part structure, frontmatter, images, checklist, confidentiality. | Every time you write a blog post. |
